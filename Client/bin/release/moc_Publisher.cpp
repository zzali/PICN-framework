...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Publisher_t, stringdata) + ofs \
...
const QMetaObject Publisher::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Publisher.data,
...
void *Publisher::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Publisher.stringdata))
